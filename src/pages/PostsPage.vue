<template>
  <div>
    ...
    <posts-list @remove="removePost" :posts="sortedAndSearched"/>
...
export default {
  components: { PostForm, PostsList, PostModal, MySelect, MyInput },
  data() {
    return {
      page: 0,
      limit: 10,
  ...
  methods: {
    createPost (post) {
      post.title.length && post.body.length && this.posts.push(post)
